        ...
        return (
            <div className='pop-content'>
                <div className='pop-content-container'>
                    ...
                    <span>
                        <a href="https://github.com/Jasleen8801?tab=repositories" target={"_blank"} rel="noopener noreferrer">
                            Fork me on Github
                        </a>
                    </span>
                    <span>
                        <a href='https://www.linkedin.com/in/jasleen-kaur-9a27b821a/' target={"_blank"} rel="noopener noreferrer">
                        ...
                        <div className='header-right-avatar'>
                            <span>
                                <div className='header-right-avatar-icon'>
                                    <span>
                                        <Popover content={<Content/>} title={<Title/>} trigger="click" visible={visible} placement="bottom" onVisibleChange={() => setvisible(!visible)}>
                                            <Avatar size={40} style={{cursor: "pointer",}} src="" alt="avatar"/>
                                        </Popover>
                                    </span>
                                </div>
                            </span>
